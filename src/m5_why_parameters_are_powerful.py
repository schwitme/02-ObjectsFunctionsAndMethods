...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),15,10,'pink',2)
    #even_better_draw_circles(rg.Point(-200,0),30,15,'purple',3)

    even_better_draw_circles(rg.Point(0,0),5,100,'lime',1)
    even_better_draw_circles(rg.Point(0,0),10,50,'cyan',2)
    even_better_draw_circles(rg.Point(0,0),20,25,'magenta',3)
...
def even_better_draw_circles(point,radii,circles,color,thick):
